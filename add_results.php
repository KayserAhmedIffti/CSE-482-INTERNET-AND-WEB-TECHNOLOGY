    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend>Enter Marks</legend>
                ...
                <input type="text" name="p1" id="" placeholder="paper-1 of NSU">
                <input type="text" name="p2" id="" placeholder="paper-2 of NSU">
                <input type="text" name="p3" id="" placeholder="paper-3 of NSU">
                <input type="text" name="p4" id="" placeholder="paper-4 of NSU">
                <input type="text" name="p5" id="" placeholder="paper-5 of NSU">
